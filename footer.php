						...
						<div class="row">
							<div class="col-12 col-xl-4">
								<div class="site-footer__widget footer-contacts">
									...
									<div class="footer-contacts__text">You can reach us through the following mediums.We are always at your service.</div>
									<address class="footer-contacts__contacts">
										<dl>
											<dt>Phone Number</dt>
											<dd><?php echo $dcomm_phone; ?></dd>
										</dl>
										<dl>
											<dt>Email Address</dt>
											<dd><?php echo $dcomm_email; ?></dd>
										</dl>
										<dl>
											<dt>Our Location</dt>
											<dd><?php echo $dcomm_address; ?></dd>
										</dl>
										<dl>
											<dt>Working Hours</dt>
							...
							<div class="col-6 col-md-3 col-xl-4 text-center">
								<div class="site-footer__widget footer-links">
									<h5 class="footer-links__title">Information</h5>
									<ul class="footer-links__list">
										<li class="footer-links__item"><a href="home" class="footer-links__link">Home</a>
										<li class="footer-links__item"><a href="about-us" class="footer-links__link">About
												Us</a></li>
										<li class="footer-links__item"><a href="services" class="footer-links__link">Our Services</a></li>
										<li class="footer-links__item"><a href="terms" class="footer-links__link">Terms & Conditions</a></li>
										</li>
							...
							<div class="col-12 col-md-6 col-xl-4">
								<div class="site-footer__widget footer-newsletter">
									<h5 class="footer-newsletter__title">Social Networks</h5>
									<div class="footer-newsletter__text">Feel free to send us messages also on our social media platform.Stay in touch with us.</div>
