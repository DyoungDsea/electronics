...
<li class="departments__list-padding" role="presentation"></li>
    <li class="departments__item departments__item--submenu--megamenu departments__item--has-submenu"><a href="#" class="departments__item-link">Headlights & Lighting 
    ...
    <div class="megamenu__image">
        ...
        <ul class="megamenu__links megamenu-links megamenu-links--root">
            <li class="megamenu-links__item megamenu-links__item--has-submenu"><a class="megamenu-links__item-link" href="#">Body Parts</a>
...
<ul class="main-menu__list">
    ...
    <li class="main-menu__item"><a href="contact" class="main-menu__link" >Help</a></li>
...
<input class="search__input" type="text" name="search" value="<?php if(isset($_GET['search']))echo $_GET['search']; ?>" placeholder="Enter Keyword "> 
...
<div class="suggestions__group-title">Products
</div>
