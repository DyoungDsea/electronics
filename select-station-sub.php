...
if(isset($_POST['Station'])){
    ...
    $out .= '<div class="col-md-6">Delivery Station</div>
    <div class="col-md-6"><select name="location" required id="mySelectsss" class="form-control form-control-sm boxx mt-2">
