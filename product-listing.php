...
<body>
			...
			<div class="block-header block-header--has-breadcrumb block-header--has-title">
				<div class="container">
					<div class="block-header__body">
						<nav class="breadcrumb block-header__breadcrumb" aria-label="breadcrumb">
							<ol class="breadcrumb__list">
								...
								<li class="breadcrumb__item breadcrumb__item--parent breadcrumb__item--first"><a
										href="home" class="breadcrumb__item-link">Home</a></li>
						...
						<h1 class="block-header__title"><?php echo $dcat; ?> -- <?php echo $subcat; ?></h1>
					</div>
				</div>
			</div>
							...
							<div class="sidebar sidebar--offcanvas--mobile">
								...
								<div class="sidebar__body">
									<div class="sidebar__header">
										<div class="sidebar__title">Filters</div><button class="sidebar__close"
	...
	C6.1,7.8,6.1,8.4,5.7,8.7z" /></svg> </span><a href="#">Construction & Repair</a>
																		...
																		<li
																			...
																			<div class="filter-categories__counter">21
																			</div>
																		</li>
																		<li
												...
												<div class="widget-filters__item">
													<div class="filter filter--opened" data-collapse-item><button
															type="button" class="filter__title"
															data-collapse-trigger>Brand <span class="filter__arrow"><svg
										...
										<div class="card widget widget-products d-none d-lg-block">
											...
											<div class="widget-products__list">
												<div class="widget-products__item">
													<div class="widget-products__image"><a href="product-full"><img
																src="images/products/product-1-64x64.jpg" alt=""></a>
													</div>
													<div class="widget-products__info">
														<div class="widget-products__name"><a
																href="product-full">Brandix Spark Plug Kit
																ASR-400</a></div>
	...
	C6,14.8,5.8,15,5.5,15h-2C3.2,15,3,14.8,3,14.5v-3C3,11.2,3.2,11,3.5,11z" /></svg> </span><span
											...
											<div class="view-options__layout layout-switcher">
												<div class="layout-switcher__list"><button type="button"
														...
														data-layout="grid" data-with-features="false"><svg width="16"
															height="16">
	...
	C0,0.4,0.4,0,0.8,0h5.4C6.6,0,7,0.4,7,0.8v5.4C7,6.6,6.6,7,6.2,7z" /></svg></button> <button type="button"
														...
														data-with-features="true"><svg width="16" height="16">
	...
	H0.8C0.4,7,0,6.6,0,6.2V0.8C0,0.4,0.4,0,0.8,0h14.4C15.6,0,16,0.4,16,0.8v5.4C16,6.6,15.6,7,15.2,7z" /></svg></button>
													<button type="button" class="layout-switcher__button"
														data-layout="table" data-with-features="false"><svg width="16"
															height="16">
	...
	C0.4,4,0,3.6,0,3.2V0.8C0,0.4,0.4,0,0.8,0h14.4C15.6,0,16,0.4,16,0.8v2.4C16,3.6,15.6,4,15.2,4z" /></svg></button></div>
											...
											<!-- <div class="view-options__select"><label
													for="view-option-sort">Sort:</label> <select id="view-option-sort"
													class="form-control form-control-sm" name="">
													<option value="">Price</option>
												</select></div>
											<div class="view-options__select"><label
													for="view-option-limit">Show:</label> <select id="view-option-limit"
													class="form-control form-control-sm" name="">
	...
	l0.6-0.6C9.3,2.4,10.3,2,11.3,2c1,0,1.9,0.4,2.6,1.1C15.4,4.6,15.4,6.9,13.9,8.4z" /></svg></button> <button
													...
													<div class="product-card__image"><a href="product-full"><img
													...
													<div class="product-card__info">
														...
														<div class="product-card__name">
															<div>
																...
																</div><a href="product-full">Brandix Spark Plug Kit
																	ASR-400</a>
															</div>
														</div>
	...
	C17.9,5.2,17.7,5,17.5,5H9.4C9.2,5,9,4.8,9,4.6V3.4C9,3.2,9.2,3,9.4,3h9.2C19.4,3,20,3.6,20,4.4z" /></svg></button>
														<button class="product-card__addtocart-full" type="button">Add
															to cart</button> <button class="product-card__wishlist"
	...
	l0.6-0.6C9.3,2.4,10.3,2,11.3,2c1,0,1.9,0.4,2.6,1.1C15.4,4.6,15.4,6.9,13.9,8.4z" /></svg> <span>Add to
															...
															class="product-card__compare" type="button"><svg width="16"
																height="16">
																<path
																	d="M9,15H7c-0.6,0-1-0.4-1-1V2c0-0.6,0.4-1,1-1h2c0.6,0,1,0.4,1,1v12C10,14.6,9.6,15,9,15z" />
																<path
	...
	l0.6-0.6C9.3,2.4,10.3,2,11.3,2c1,0,1.9,0.4,2.6,1.1C15.4,4.6,15.4,6.9,13.9,8.4z" /></svg></button> <button
													...
													<div class="product-card__info">
														...
														<div class="product-card__name">
															<div><a href="product-full">Brandix Brake Kit
																	BDX-750Z370-S</a></div>
														</div>
														<div class="product-card__rating">
															<div class="rating product-card__rating-stars">
													...
													<div class="product-card__info">
														...
														<div class="product-card__name">
															<div>
																<div class="product-card__badges">
																	<div class="tag-badge tag-badge--sale">sale</div>
																</div><a href="product-full">Left Headlight Of
																	Brandix Z54</a>
															</div>
														</div>
														<div class="product-card__rating">
