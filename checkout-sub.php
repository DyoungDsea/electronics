...
<body><!-- site --><div class="site">
        ...
        <form action="sub-process" method="POST">
            ...
            <div class="row mt-2" id="station"> </div>

            <div class="row mt-3" id="stationPickx">
                <div class="col-md-6">Delivery Charges</div>
                <div class="col-md-6" id="charges">
                    &#8358;0.00
                </div>
            </div>

            <div class="row mt-3" id="stationPicks">
                <div class="col-md-6">Total Subscription</div>
                <div class="col-md-6" id="grand"> </div>
            </div>
       ...
       <button type="submit" disabled id="mySubmit" class="btn btn-primary btn-xl btn-block" href="#">Submit Subscription</button>
       </div>
