                ...
                <div class="col-md-6 d-flex">
                    <div class="card flex-grow-1 mb-md-0 mr-0 mr-lg-3 ml-0 ml-lg-4">
                        <div class="card-body card-body--padding--2">
                            ...
                            <?php if(isset($_SESSION['msgsx'])){
                                echo $_SESSION['msgsx'];
                            }?>
                            <form method="post" action="forgot-process">
                                <div class="form-group">
                                    <label for="signin-email">Email address</label> 
                                    <input id="signin-email" required name="email" type="email" class="form-control" placeholder="youremail@gmail.com">
                                </div>
                                
                            <div class="form-group mb-0">
                                <button type="submit" name="log"  class="btn btn-primary mt-3">RESET</button>
                            </div>
                        </form>
...
<?php include("mobile-header2.php"); ?>
    ...
    <?php include("scripts.php"); unset($_SESSION['msgsx']); ?>
 </body>
