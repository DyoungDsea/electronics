...
function spamcheck($field)
  ...
  $spam1 = strip_tags($_POST['spam1']);
    ...
    if($spam1==$spam2){
        $sql=$conn->query("INSERT INTO _security SET userid='$userid', email='$email', uname='$name', dcompany='$store', pword='$pass', drank='seller', address='$address', dphone='$phone', privilege='staff', dprivilege='Product', status='online'");
        if($sql){
