...
<div class="block-space block-space--layout--divider-xs"></div>
    ...
    <div class="owl-carousel"><a class="block-slideshow__item" href="#">

    <span class="block-slideshow__item-image block-slideshow__item-image--desktop" style="background-image: url('images/slides/slide-3.jpg')">
    </span> 
    ...
    <span class="block-slideshow__item-offer">30% OFF 
    </span>

    <span class="block-slideshow__item-title">When Buying Parts
    <br>With Installation 
    </span>

    <span class="block-slideshow__item-details">Installation of parts in the services of
    <br>our partners. 
    </span>

    <span class="block-slideshow__item-button">Shop Now 
    </span></a><a class="block-slideshow__item" href="#">

    <span class="block-slideshow__item-image block-slideshow__item-image--desktop" style="background-image: url('images/slides/slide-2.jpg')">
    </span> 
    ...
    <span class="block-slideshow__item-title">Not enough
    <br>spare parts? 
    </span>

    <span class="block-slideshow__item-details">We have everything you need – replacement parts,
    <br>performance parts, accessories, oil & fluids,
    <br>tools and much more... 
    </span>

    <span class="block-slideshow__item-button">Shop Now 
    </span></a><a class="block-slideshow__item" href="#">

    <span class="block-slideshow__item-image block-slideshow__item-image--desktop" style="background-image: url('images/slides/slide-1.jpg')">
    </span> 
    ...
    <span class="block-slideshow__item-title">Big Choice Of
    <br>Wheel Tires 
    </span>

    <span class="block-slideshow__item-details">Any size and diameter, with or without spikes,
    <br>summer or winter, rain or snow. 
    </span>
...
<div class="block-categories__title">Popular Categories
...
<div class="category-card__image"><a href="#"><img src="images/categories/category-1-160x160.jpg" alt=""></a>
</div>

<div class="category-card__info">

<div class="category-card__name"><a href="#">Headlights</a>
</div>
...
<div class="category-card__actions"><a href="#" class="category-card__link">Shop All</a>
</div>
</div>
</div>
</div>
...
<div class="category-card__image"><a href="#"><img src="images/categories/category-2-160x160.jpg" alt=""></a>
</div>

<div class="category-card__info">

<div class="category-card__name"><a href="#">Fuel System</a>
</div>
<ul class="category-card__children">
...
<div class="category-card__image"><a href="#"><img src="images/categories/category-3-160x160.jpg" alt=""></a>
</div>

<div class="category-card__info">

<div class="category-card__name"><a href="#">Body Parts</a>
</div>
<ul class="category-card__children">
...
<div class="category-card__image"><a href="#"><img src="images/categories/category-4-160x160.jpg" alt=""></a>
</div>

<div class="category-card__info">

<div class="category-card__name"><a href="#">Interior Parts</a>
</div>
<ul class="category-card__children">
...
<div class="category-card__image"><a href="#"><img src="images/categories/category-5-160x160.jpg" alt=""></a>
</div>

<div class="category-card__info">

<div class="category-card__name"><a href="#">Wheels & Tires</a>
</div>
<ul class="category-card__children">
...
<div class="category-card__image"><a href="#"><img src="images/categories/category-6-160x160.jpg" alt=""></a>
</div>
					...
					<div class="section-header">
						<div class="section-header__body">
							...
							<ul class="section-header__groups">
								...
								<li class="section-header__groups-item"><button type="button"
										class="section-header__groups-button">Sort</button></li>
							</ul>
...
<div class="block-sale__title">Attention! Deal Zone
</div>

<div class="block-sale__subtitle">Hurry up! Discounts up to 70%
</div>
...
<div class="timer__part-value timer__part-value--days">02
</div>

<div class="timer__part-label">Days
</div>
</div>
...
<div class="timer__part-value timer__part-value--hours">23
</div>

<div class="timer__part-label">Hrs
</div>
</div>
...
<div class="timer__part-value timer__part-value--minutes">07
</div>

<div class="timer__part-label">Mins
</div>
</div>
...
<div class="timer__part-value timer__part-value--seconds">54
</div>

<div class="timer__part-label">Secs
</div>
</div>
</div>
</div>
...
<div class="arrow block-sale__arrow block-sale__arrow--prev arrow--prev"><button class="arrow__button" type="button"><svg width="7" height="11">
...
<div class="block-sale__link"><a href="#">View All Available Offers</a>
</div>

<div class="arrow block-sale__arrow block-sale__arrow--next arrow--next"><button class="arrow__button" type="button"><svg width="7" height="11">

<path d="M0.3,10.7L0.3,10.7c0.4,0.4,0.9,0.4,1.3,0L7,5.5L1.6,0.3C1.2-0.1,0.7,0,0.3,0.3l0,0c-0.4,0.4-0.4,1,0,1.3l4,3.9l-4,3.9
	C-0.1,9.8-0.1,10.4,0.3,10.7z"/></svg></button>
</div>
...
<div class="container">
							<div class="block-sale__carousel">
								<div class="owl-carousel">
								<?php 
									$sql = $conn->query("SELECT * FROM products WHERE dcategory='electronics' ORDER BY RAND() LIMIT 10");
									if($sql->num_rows>0){
										while($row=$sql->fetch_assoc()):
											$product = $row['dpid'];
									...
									<div class="block-sale__item">
										<div class="product-card">
											...
											<div class="product-card__footer">
												...
												<a href="product-full?product_id=<?php echo $row['dpid']; ?>&product_name=<?php echo $row['dpname']; ?>&brand=<?php echo $row['dbrand']; ?>&category=<?php echo $row['dcategory']; ?>" class="product-card__addtocart-icon" 
													aria-label="Add to cart"><svg width="20" height="20">
														<circle cx="7" cy="17" r="2" />
														<circle cx="15" cy="17" r="2" />
...
<div class="block-space block-space--layout--divider-nl d-xl-block d-none">
</div>
...
<path d="M29.6,21.9c0.4,0,0.8-0.3,0.8-0.8s-0.3-0.8-0.8-0.8h-3.2c-0.4,0-0.8,0.3-0.8,0.8v6.4c0,0.4,0.3,0.8,0.8,0.8h3.2
	c0.4,0,0.8-0.3,0.8-0.8s-0.3-0.8-0.8-0.8h-2.5v-1.7H28c0.4,0,0.8-0.3,0.8-0.8s-0.3-0.8-0.8-0.8h-0.9v-1.7L29.6,21.9L29.6,21.9z"/></svg>
</div>

<div class="block-features__item-info">

<div class="block-features__item-title">Free Shipping
</div>

<div class="block-features__item-subtitle">For orders from $50
</div>
</div></li>
<li class="block-features__item">
...
<path d="M0.403,23.192c0.998,3.783,2.422,7.199,4.232,10.155c1.81,2.956,4.206,5.777,7.121,8.386
    ...
    c0.865,1.414,0.61,3.243-0.524,4.383L10.586,4.788C12.12,4.295,13.864,4.903,14.728,6.314L14.728,6.314z M14.728,6.314"/></svg>
</div>

<div class="block-features__item-info">

<div class="block-features__item-title">Support 24/7
</div>

<div class="block-features__item-subtitle">Call us anytime
</div>
</div></li>
<li class="block-features__item">
...
<path d="M40.3,33.5c-1.2,0-2.1,0.9-2.1,2.1c0,0.9,0.5,1.6,1.3,1.9v1.1c0,0.4,0.4,0.8,0.8,0.8s0.8-0.4,0.8-0.8v-1.1
	...
	S40.1,35.1,40.3,35.1z"/></svg>
</div>

<div class="block-features__item-info">

<div class="block-features__item-title">100% Safety
</div>

<div class="block-features__item-subtitle">Only secure payments
</div>
</div></li>
<li class="block-features__item">
...
<path d="M27.4,15.8l1.8-1.8c0.3-0.3,0.3-0.8,0-1.1c-0.3-0.3-0.8-0.3-1.1,0l-4.7,4.7c-0.3,0.3-0.3,0.8,0,1.1c0.2,0.2,0.4,0.2,0.5,0.2
	s0.4-0.1,0.5-0.2l1.8-1.8l5.3,5.3c0.2,0.2,0.4,0.2,0.5,0.2c0.2,0,0.4-0.1,0.5-0.2c0.3-0.3,0.3-0.8,0-1.1L27.4,15.8z"/></svg>
</div>

<div class="block-features__item-info">

<div class="block-features__item-title">Hot Offers
</div>

<div class="block-features__item-subtitle">Discounts up to 90%
</div>
</div></li>
</ul>
</div>
...
<!-- Mirrored from red-parts.html.themeforest.scompiler.ru/themes/red-ltr/index2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 02 May 2020 23:12:02 GMT -->
