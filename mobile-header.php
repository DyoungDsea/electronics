...
<input type="text" class="mobile-search__input"  name="search" value="<?php if(isset($_GET['search']))echo $_GET['search']; ?>" placeholder="Enter keyword"> <button type="button" class="mobile-search__vehicle-picker" aria-label="Select Vehicle">
...
<div class="mobile-indicator d-none d-md-block"><a href="login" class="mobile-indicator__button">
...
<div class="mobile-indicator d-none d-md-block"><a href="wishlist" class="mobile-indicator__button">
...
<div class="mobile-indicator"><a href="cart" class="mobile-indicator__button">
