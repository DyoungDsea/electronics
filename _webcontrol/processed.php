...
.sweep,.sweep2{
      ...
      <form method="post" action="orders_filter" id="tarp">
               <div class="col-md-6" style="float:left;">
                 <div class="form-group">
                   <input type="text" placeholder="Search For Order Id" name="proc_name" value="<?php if(isset($_GET['pro_name'])){echo $_GET['pro_name'];} ?>" class="form-control it">
                 </div>
               </div>
 ...
 <div class="card mb-3">
          <div class="card-header">
            ...
            Manage Processed Orders <span class="text-danger"><?php if(isset($_GET['page_no']) AND @$_GET['page_no'] !=0){ echo "(".$_GET['page_no'].")";} ?></span></div>
          <div class="card-body">
            <div class="table-responsive"  style="min-height:200px">
              <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  while($k=$sky->fetch_assoc()){ ?>
                    <tr>
                      ...
                      <div class="btn-group" >
                          ...
                          <li><a class="nav-link " id="markShip" orderId="<?php echo $k['orderid']; ?>" href="#">Mark as Ship</a></li>
               ...
               <?php
                  ...
                  echo '<tr>
                  <td colspan="7" class="text-danger">Sorry! there is no processed orders </td>
                  </tr>';
                }
                ?>
                </tbody>
