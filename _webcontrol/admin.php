    ...
    <div style="position:fixedx;margin-top:75px;">
      ...
      <li class="nav-item">
        <a class="nav-link" href="manage-delivery"><i class="fa fa-address-book"></i> Manage Delivery Option </a>
      </li>
      ...
      <li class="nav-item">
        <a class="nav-link" href="coupon"><i class="fas fa-cog"></i> Manage Coupon</a>
      </li>
      ...
      <li class="nav-item">
        <a class="nav-link" href="settings"><i class="fas fa-cog"></i> Manage Site Settings</a>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="notification"><i class="fas fa-cog"></i> Manage Notification</a>
      </li>
